    ...
    <section id="empresas" className="py-[84px] max-[620px]:py-[60px]">
      <div className="wrap grid grid-cols-2 gap-11 items-center max-[980px]:grid-cols-1">
        <div className="img-rede rounded-raio overflow-hidden border border-linha max-[980px]:order-2">
          <img src="https://images.unsplash.com/photo-1664575602276-acd073f104c1?auto=format&fit=crop&q=80&w=800" alt="Reunião de negócios" className="w-full h-auto block transform hover:scale-105 transition-transform duration-[10s]" loading="lazy"/>
        </div>
        <div className="max-[980px]:order-1">
          ...
          <div className="flex gap-[14px]">
            <a className="btn btn-linha" href="#falar-consultor">Falar com um consultor B2B</a>
          </div>
        </div>
      </div>
    </section>
